...
const bookMixin = {
	...
	methods: {
		...mapMutations({
			...
			updateBookName: 'book/updateBookName',
			updateBookLength: 'book/updateBookLength',
			updateBookRecord: 'book/updateBookRecord',
			updateBookReadStatus: 'book/updateBookReadStatus',
			updateBookReadTime: 'book/updateBookReadTime',
